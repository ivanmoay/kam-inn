    ...
    <section class="section">
        <div class="row">            
            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title">Extend {{$room->room_name}}</h5>

                    <form method="POST" action="/extend/{{$room->id}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Date/Time Extend</label>
                            <div class="col-sm-10">      
                                @php                                    
                                    date_default_timezone_set('Asia/Manila');
                                @endphp                      
                        ...
                        <x-form-bottom-buttons submit_txt="Extend" />
                    </form>
